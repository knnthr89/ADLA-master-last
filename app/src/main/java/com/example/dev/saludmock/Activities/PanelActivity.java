...
public class PanelActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_download_campaign) {
            ...
            Intent intent = new Intent(this, AnestesiaActivity.class);
            startActivity(intent);
        ...
        } else if (id == R.id.nav_recuperacion) {

            Intent intent = new Intent(this, RecuperacionActivity.class );
            startActivity(intent);
