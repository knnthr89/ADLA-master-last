...
**/
     ...
     /*           URL url = null;
                ...
                */
                ...
                Toast.makeText(getApplicationContext(), "Su mascota ha sido registrada correctamente con el número de folio " + idDocumentS + " y el peso de la mascota es " + pesoString, Toast.LENGTH_LONG).show();
